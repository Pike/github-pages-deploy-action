...
exports.deploy = exports.generateBranch = exports.init = void 0;
...
function generateBranch(action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield execute_1.execute(`git push --force ${dry}${action.repositoryPath} ${action.branch}`, action.workspace, action.silent);
...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield execute_1.execute(`git push --force ${dry}${action.repositoryPath} ${temporaryDeploymentBranch}:${action.branch}`, `${action.workspace}/${temporaryDeploymentDirectory}`, action.silent);
            ...
            if (action.singleCommit) {
                ...
                yield execute_1.execute(`git push origin ${action.branch} ${dry}--force`, `${action.workspace}/${temporaryDeploymentDirectory}`, action.silent);
